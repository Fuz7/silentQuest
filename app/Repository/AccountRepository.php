...
class AccountRepository
{
  ...
  public function getLatestDateActivity(int $user_id)
  {
  ...
  public function getDataByDate(Request $request, int $user_id)
  {
    ...
    $dataArray = array(
      "meditationTime" => $convertedMeditationTime,
  ...
  public function getAllUniqueYears(int $user_id)
  {
  ...
  public function getMonthsByYear(int $user_id, $year)
  {
  ...
  public function getDaysByMonthAndYear(int $user_id, $year, $month)
  {
