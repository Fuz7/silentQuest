...
export default function Register(){
  return(
    ...
    <section className="min-h-[100vh] relative flex flex-col items-end pr-[300px] pt-[160px]">
      ...
      <h1 className="font-Poppins-Bold text-[88px] text-[#272628] mb-[70px]">Create Account</h1>
        <Form route={route} />
       <div className="flex  w-full justify-center gap-[10px] max-w-[450px] mt-[20px]">
        <p className="font-Poppins-Regular text-[20px] text-[#323232]">Already Have an account?</p>
...
function Form({route}){
  ...
  return(<>
      ...
      <div className="flex gap-[5px] mt-[12px] mb-[27px]">
        ...
        <p className="font-Poppins-Regular text-[#E91429]">{errors.username}</p>
      </div>
       )}
      <input
      value={data.email}
      ...
      <div className="flex gap-[5px] mt-[12px] mb-[27px]">
        <img src={registerErrorIcon} alt="" />
        <p className="font-Poppins-Regular text-[#E91429]">{errors.email}</p>
      </div>
       )}
      ...
      <div className="flex gap-[5px] mt-[12px] mb-[27px]">
        <img src={registerErrorIcon} alt="" />
        <p className="font-Poppins-Regular text-[#E91429]">{errors.password}</p>
      </div>
       )}
       <button 
       type="button"
       ...
       text-[#FFFFFF] border-none h-[55px] rounded-[16px] ">Create Account</button>
       </form>
  </>)
}