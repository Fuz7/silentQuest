...
function Form({ route }) {
    ...
    return (
       ...
       pb-[5px] w-[450px] ${
           errors.username ? "border-[#E91429]" : "mb-[40px] border-[#979CA6]"
       } 
         focus-visible:outline-none`}
                ...
                <input
                    ...
                    className={`border-b-[1px] font-Poppins-Regular text-[20px]
       pb-[5px] w-[450px] ${
           errors.email ? "border-[#E91429]" : "mb-[40px] border-[#979CA6]"
       } 
         focus-visible:outline-none`}
                    type="text"
                />
                ...
                <div className="relative w-fit mb-[50px]">
                    <input
                        ...
                        className={`border-b-[1px] font-Poppins-Regular text-[20px]
       pb-[5px] w-[450px] ${
           errors.password ? "border-[#E91429]" : "mb-[40px] border-[#979CA6]"
       } 
         focus-visible:outline-none`}
